...
PLEASE CHANGE THE A FILE PATH ON LINE 23 , 24 , 191
---EX : IF YOU USING THIS ON WINDOWS
23 : open("c:/LegendAssistant.txt" , "a+")
24 : with open("c:/LegendAssisyant.txt") as f
191 : with open("c:/LegendAssistant.txt" , "a") as r
THIS IS A EXAMPLE , YOU CAN CHANGE A PATH TO ANYWHERE
RECOMMENDED : TO DOWNLOAD THE FILE : https://pastebin.com/dl/s6iRE65M
'''
y = {}
try :
    open("/sdcard/LegendAssistant.txt" , "a+")
...
def add_dict() :            #Change dict
			...
			while True :
				...
				if x2 == '' :
					x2 = 'NoneType'
				try :
					    with open('/sdcard/LegendAssistatnt.txt' , 'a') as r :
